...
class DocumentAdmin(admin.ModelAdmin):
    list_display = ('title', 'property', 'document_type', 'uploaded_by', 'uploaded_at', 'file_size', 'mime_type')
    list_filter = ('document_type', 'uploaded_at')
    readonly_fields = ('file_size', 'mime_type', 'uploaded_at', 'updated_at', 'uploaded_by')
    exclude = ('file_size', 'mime_type')  # Hide these fields from the form since they're auto-filled
